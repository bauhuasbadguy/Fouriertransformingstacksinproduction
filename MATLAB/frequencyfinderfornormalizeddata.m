...
for counter1 = 0:1:initnumberofimages-1
    ...
    if counter1 <= 9 && counter1 >=1
        ...
        imagestack(:,:,q1) = dlmread([filestyle,'00',num2str(counter1),'normalized.txt']);
        
    elseif counter1 <= 99 && counter1 >= 10
        
        imagestack(:,:,q1) = dlmread([filestyle,'0',num2str(counter1),'normalized.txt']);
        
    elseif counter1 == 0
        imagestack(:,:,q1) = dlmread([filestyle,'000','normalized.txt']);
        
    else
        
        imagestack(:,:,q1) = dlmread([filestyle,num2str(counter1),'normalized.txt']);
